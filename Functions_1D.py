# TODO: None of these functions are manually tested, and almost all of them are generated by Claude code, under supervision.
...
class SumOfExps(Funcs1D):
	...
	def __add__(self, other):
		if isinstance(other, ExpFunc):
			...
			assert isinstance(other, SumOfExps)
	...
	def __mul__(self, other):
		if isinstance(other, SumOfExps):
			...
			mul_res = self.copy()
			assert isinstance(mul_res, SumOfExps)
	...
	def derivative(self):
		der_fn = self.copy()
		assert isinstance(der_fn, SumOfExps)
